...
class DumpsRoute extends DtbRoute {
    ...
    displayHelp() {
        const systemDumpDefinition = 'A system dump is an export of your entire data (contents, users, groups, roles, ...) from your Enonic XP server to a serialized format.\n' +
                           ...
                           'System dumps generated by Enonic XP >=6.11 are similar to backups. They contain the version history of the nodes and loading these system dumps will delete existing data.\n' +
                           'See https://developer.enonic.com/docs/xp/stable/deployment/data#dump_and_load for more information.';
        ...
        new HelpDialog('Dumps', [systemDumpDefinition, repoDumpDefinition, viewDefinition]).init()
