class NodesRoute extends DtbRoute {
    ...
    displayHelp() {
        ...
        new HelpDialog('Node Tree', [definition, structureDefinition, viewDefinition]).
        init().
        addActionDefinition({
        ...
        addActionDefinition({iconName: 'info',definition: 'Display the node view containing more details and actions about this node.'}).
